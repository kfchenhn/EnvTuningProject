#!/bin/bash
# Multi-Turn FC RL Training Script (Stage 4: robustness / no env hints)
...
EXPERIMENT_NAME="watt-tool-8B-base-stage4-robustness-no-hints_$(now)"
MODEL="/agent/*Your local model path."
DATA_DIR="$PROJECT_DIR/data"
ROLLOUT_DIR="$USER_ROOT_PATH/rollout/$PROJECT_NAME/$EXPERIMENT_NAME"
LOG_DIR="$PROJECT_DIR/logs"
LOG_FILE="$LOG_DIR/bfcl_multi_turn_rl_stage4_${TIMESTAMP}.log"
